...
resource "azurerm_kubernetes_cluster_node_pool" "node_pool_app"  {
    ...
    vnet_subnet_id        = var.subnet_id[0]
    enable_auto_scaling   = var.auto_scaling_app_enabled
    min_count             = var.auto_scaling_app_enabled ? var.agents_min_count_app : null
    max_count             = var.auto_scaling_app_enabled ? var.agents_max_count_app : null
    enable_node_public_ip = var.node_public_ip_enabled
    kubernetes_cluster_id = azurerm_kubernetes_cluster.aks_cluster.id
...
resource "azurerm_kubernetes_cluster_node_pool" "node_pool_monitor"  {
    ...
    vnet_subnet_id        = var.subnet_id[0]
    enable_auto_scaling   = var.auto_scaling_monitor_enabled
    min_count             = var.auto_scaling_monitor_enabled ? var.agents_min_count_monitor : null
    max_count             = var.auto_scaling_monitor_enabled ? var.agents_max_count_monitor : null
    enable_node_public_ip = var.node_public_ip_enabled
    kubernetes_cluster_id = azurerm_kubernetes_cluster.aks_cluster.id
  ...
  resource "azurerm_kubernetes_cluster_node_pool" "node_pool_database"  {
    ...
    vm_size               = var.managed_node_pool_monitor_size
    vnet_subnet_id        = var.subnet_id[0]
    enable_auto_scaling   = var.auto_scaling_database_enabled
    min_count             = var.auto_scaling_database_enabled ? var.agents_min_count_database : null
    max_count             = var.auto_scaling_database_enabled ? var.agents_max_count_database : null
    enable_node_public_ip = var.node_public_ip_enabled
    kubernetes_cluster_id = azurerm_kubernetes_cluster.aks_cluster.id
